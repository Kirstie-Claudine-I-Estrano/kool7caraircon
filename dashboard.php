...
<header>
    ...
    <img src="bell.png" class="icn" alt="Notification Bell"
     style="border-radius: 50%;"
     onmouseover="this.style.boxShadow='0px 0px 10px rgba(255, 255, 255, 0.5)';"
     onmouseout="this.style.boxShadow='none';">

        <img src="logo 2.png" alt="dp" style="width: 50px; height: 50px; border-radius: 50%; margin-left: 10px;"
             onmouseover="this.style.boxShadow='0px 0px 10px rgba(255, 255, 255, 0.5)';"
             onmouseout="this.style.boxShadow='none';">
    </a>
</div>
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<td>
                                                ...
                                                <form action="approved.php" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit" name="approved_client_btn" class="btn btn-success btn-sm">Approve</button>
                                                </form>
                                                <!-- Cancelled button -->
