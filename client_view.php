                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Client Details 
                            ...
                            <form action="client_delete.php" method="POST" class="d-inline">
                                <input type="hidden" name="id" value="<?= $client['id']; ?>">
                                <button type="submit" class="btn btn-danger float-end me-2" onclick="return confirm('Are you sure you want to delete this appointment?');">Delete</button>
                            </form>
                        </h4>
                    </div>
                    <div class="card-body">
